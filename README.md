...
27Apr23 - Adopted GNU GPLv3 for these works. Added example of using UI to go interactive with user
when host system cpu utilization exceeds some programmatic value at print start.
